Feature: Create user
  ...
  @CreateUserAPI  @CreateUser01 @All
  ...
  @CreateUserAPI  @CreateUser02 @All
  Scenario: Error is thrown when creating a user with existing email id
    #Api setup start
    Given request '01-CreateUser' have path '/users'
    Given request '01-CreateUser' have request body '/createUser/scenario1/input/requestBody.json'
    ...
    Given request '02-CreateUser' have request body '/createUser/scenario2/input/requestBody.json'
  ...
  @CreateUserAPI  @CreateUser03 @All
  ...
  @CreateUserAPI  @CreateUser04 @All
  ...
  @CreateUserAPI  @CreateUser05 @All
  ...
  @CreateUserAPI  @CreateUser06 @All
